package com.zlove.channelmvp.fragment.customer;
...
import com.zlove.channelmvp.adapter.customer.CustomerListAdapter;
...
import com.zlove.channelmvp.model.customer.CustomerListModel;
import com.zlove.channelmvp.presenter.customer.CustomerListPresenter;
 ...
 */
public class CustomerListFragment extends BaseFragment<CustomerListPresenter, CustomerListModel> implements CustomerListContract.View, OnRefreshListener, OnLoadMoreListener {
    ...
    protected void initView() {
        ...
        mAdapter = new CustomerListAdapter(getContext());
        ...
        if (mAdapter.getSize() <= 0) {
            mPresenter.getCustomerList("", "", "", "", String.valueOf(pageIndex), "10", "", "");
        }
    }
    ...
    public void getCustomerListSuccess(CustomerListBean bean) {
        if (bean != null) {
            if (bean.getStatus() == 200) {
                ...
                List<CustomerListBean.CustomerListData.CustomerListItem> list = bean.getData().getClient_list();
                if (isRefresh) {
